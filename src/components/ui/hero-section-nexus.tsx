...
const DropdownMenu: React.FC<DropdownMenuProps> = ({ children, isOpen }) => (
   <AnimatePresence>
     {isOpen && (
       ...
       >
           <div className="bg-taxi-black border border-gray-700/50 rounded-md shadow-xl p-2">
               {children}
           </div>
       </motion.div>
     )}
...
const InteractiveHero: React.FC = () => {
       ...
       for (let i = 0; i < cols; i++) {
           for (let j = 0; j < rows; j++) {
               ...
               newDots.push({
                   x,
                   y,
                   baseColor: `rgba(255, 215, 0, ${BASE_OPACITY_MAX})`,
   ...
   const animateDots = useCallback(() => {
       ...
       dots.forEach((dot, index) => {
           ...
           ctx.beginPath();
           ctx.fillStyle = `rgba(255, 215, 0, ${finalOpacity.toFixed(3)})`;
  ...
  return (
    <div className="pt-[100px] relative bg-taxi-black text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
        <canvas ref={canvasRef} className="absolute inset-0 z-0 pointer-events-none opacity-80" />
        <div className="absolute inset-0 z-1 pointer-events-none" style={{
            background: 'linear-gradient(to bottom, transparent 0%, hsl(var(--taxi-black)) 90%), radial-gradient(ellipse at center, transparent 40%, hsl(var(--taxi-black)) 95%)'
        }}></div>
        ...
        >
            <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                <div className="flex items-center flex-shrink-0">
                    ...
                    <span className="text-2xl font-bold text-white ml-3">Goovista</span>
                </div>
                ...
                <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
                    ...
                    <motion.a
                        href="#signup"
                        className="bg-primary text-primary-foreground px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-taxi hover:shadow-lg"
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="md:hidden absolute top-full left-0 right-0 bg-taxi-black/95 backdrop-blur-sm shadow-lg py-4 border-t border-gray-800/50"
                    >
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
            ...
            <motion.div
                ...
                className="mb-6"
            >
                <ShinyText text="🚕 Premium Taxi Service" className="bg-gradient-to-r from-primary to-accent text-primary-foreground px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer border border-primary/30 transition-colors" />
            </motion.div>
            ...
            >
                ...
                <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                    <RotatingText
                        texts={['Ride', 'Trip', 'Journey', 'Taxi', 'Drive']}
            ...
            >
                Fast, reliable, and comfortable rides at your fingertips. Book your taxi in seconds and arrive in style.
            </motion.p>
            ...
            >
                <motion.a
                    href="#book"
                    className="w-full sm:w-auto bg-primary text-primary-foreground px-8 py-3 rounded-lg text-lg font-bold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-taxi hover:shadow-lg flex-shrink-0"
                    whileHover={{ scale: 1.03, y: -1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ type: "spring", stiffness: 400, damping: 15 }}
                >
            ...
            >
                Available 24/7 • Quick Response • Safe & Secure
            </motion.p>
            ...
            >
                <span className="text-xs uppercase text-gray-500 tracking-wider font-medium">Vehicle Types</span>
                <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-gray-400">
                    <span className="flex items-center whitespace-nowrap">🚗 Sedan</span>
                    <span className="flex items-center whitespace-nowrap">🚙 SUV</span>
                    <span className="flex items-center whitespace-nowrap">🚐 Maxi</span>
                    <span className="flex items-center whitespace-nowrap">♿ Accessible</span>
                    <span className="flex items-center whitespace-nowrap">✨ Premium</span>
                </div>
            </motion.div>
